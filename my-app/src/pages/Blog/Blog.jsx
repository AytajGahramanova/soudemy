  ...
  if (searchData == "")
    return (
      <div className="flex items-center justify-center text-center mt-[8rem]">
        <p className="text-red-600 text-[30px] font-medium">Belə məlumat yoxdur</p>
      </div>
    );
  ...
  return (
    <div>
      <div className="w-[90%] m-auto">
        <FadeIn>
          <div className="flex md:items-end items-center md:gap-18 gap-6 md:flex-row flex-col"></div>
                ...
                return (
                  <div key={item.id} className="cursor-pointer mb-10">
                    ...
                    <div className="flex flex-col">
                      <h2 className="text-[30px] py-5 font-bold">
                        {item.title}
                      </h2>
            ...
            <div className="md:w-[20%] w-full flex flex-col gap-5">
              <div>
                <input
                  ...
                  className="border border-[#A9A3A3] p-2 outline-none w-full"
                  placeholder="Search..."
                />
              </div>
              <div>
